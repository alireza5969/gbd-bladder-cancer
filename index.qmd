...
author: 
  ...
  - name: Ehsan Taherifard
    ...
    affiliations:
      - ref: shiraz
  - name: Amirabbas Tavakoli
    orcid: 0009-0003-9363-7974
    corresponding: false
    email: amirtvk88@gmail.com
    degrees: MD
    roles: [writing – review & editing, resources, data curation]
    affiliations:
      - ref: shiraz
...
We calculated both absolute differences ([Supporting Files](#sup-percentchange)) and rate ratios (@fig-discrep) between male and female BC burden measures.
...
A complementary quantitative summary of the trends shown in @fig-performance is provided in [Supporting Files](#sup-percentchange), which presents the percentage change in age-standardized rates between 1980 and 2021 for all burden measures. Consistent with the visual trends, the table demonstrates significant reductions in DALYs (`r green_change_txt[3]`, `r green_change_txt[2]`, `r green_change_txt[1]`, and `r green_change_txt[4]`) and YLLs (`r green_change_txt[10]`, `r green_change_txt[9]`, `r green_change_txt[8]`, and `r green_change_txt[11]`) across high-income and high-SDI countries, the European Union, and the U.S., respectively. By contrast, while high-income and high-SDI countries and the European Union achieved significant declines in mortality (`r green_change_txt[7]`, `r green_change_txt[6]`, and `r green_change_txt[5]`, respectively) and male incidence (`r incidence_green_change_txt[3]`, `r incidence_green_change_txt[4]`, `r incidence_green_change_txt[1]`), changes in the U.S. were comparatively modest and statistically non-significant (`r incidence_green_change_txt[2]`).
...
2.  **Geographically faceted state-level trend plots**\
    Geofacet plots illustrating historical age-standardized trends in bladder cancer burden measures across U.S. states are available from the project’s [GitHub repository](https://github.com/alireza5969/gbd-bladder-cancer/tree/main/output/figures/Geofacet%20plot).     
  ```
  States are abbreviated as `r paste0(c(measure_abbs, country_abbs, state_abbs), collapse = "; ")`.[ ](){#sup-geofacet}
  ```

3.  **State-level population pyramids (2021)**\
...
4.  **Animated population pyramids**\
